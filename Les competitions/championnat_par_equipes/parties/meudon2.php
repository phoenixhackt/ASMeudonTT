...
<head>
    ...
    <title>AS Meudon Tennis de Table - Résultats Meudon AS 2</title>
...
<body>
    ...
    <main>
        ...
        $getPouleClassement = $service->getPouleClassement('125922', '655864');
        $getPouleRencontres = $service->getPouleRencontres('125922', '655864');
        ?>
